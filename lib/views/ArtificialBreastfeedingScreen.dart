...
class ArtificialBreastfeedingScreen extends StatelessWidget {
  final ArtificialBreastfeedingController controller = Get.put(ArtificialBreastfeedingController());
        ...
        children: [
          ...
          Expanded(
            ...
            child: ElevatedButton.icon(
              ...
              label: Text('choose_time'.tr, style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: Colors.white)),
              style: ElevatedButton.styleFrom(
                backgroundColor: Color(0xFF49CBD2),
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(30.0),
